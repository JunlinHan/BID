...
class Unaligned5Dataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.dir_E = os.path.join(opt.dataroot, opt.phase + 'E')  # create a path '/path/to/data/trainC'
...
#        print('current_epoch', self.current_epoch)
        ...
        return {'A': A, 'B': B, 'C': C, 'D': D, 'E': E, 'A_paths': A_path, 'B_paths': B_path, 'C_paths': C_path, 'D_paths': D_path, 'E_paths': E_path}
