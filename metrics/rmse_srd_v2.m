%% compute rmse for SRD (V2)
clear;close all;clc

% mask directory|mask
maskdir = 'C:\Users\76454\Desktop\BID\datasets\jointremoval_v2\testB\';
MD = dir([maskdir '/*.jpg']);

% ground truth directory|GT
freedir = 'C:\Users\76454\Desktop\BID\datasets\jointremoval_v2\testA\'; 
FD = dir([freedir '/*.jpg']);

% predicted result directory
shadowdir = 'C:\Users\76454\Desktop\BID\results\task3_v2\test_latest\images\fake_A\';
