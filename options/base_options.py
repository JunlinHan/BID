...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='BIDeN', help='chooses which model to use.')
        ...
        parser.add_argument('--num_threads', default=0, type=int, help='# threads for loading data, set this to 0 if you are using Windows OS.')
